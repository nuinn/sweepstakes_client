        ...
        <>
          ...
          <div className='content'>
            ...
            <div className="player">
              ...
              {!finished && player && <p className='points'>{`${(player.teamsData.reduce((sum, team) => sum + team.group.won + team.KO.won, 0)*3)+(player.teamsData.reduce((sum, team) => sum + team.group.drawn + team.KO.drawn, 0))} pts`}</p>}
            </div>
          </div>
        </>
    </StyledTeamCard>
